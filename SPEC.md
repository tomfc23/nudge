...
- **Regression:** `npm test` (39 tests: classifier, config/token chain, access modes, event→publish flow, dedupe/cooldown incl. concurrent-instance sharing, log rate-limit, tool) and `tsc --noEmit` both green after all changes.
