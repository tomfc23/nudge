...
const PACKAGE_FILES = ["index.ts", "install.sh", "package.json", "package-lock.json", "src", "adapters", "scripts/setup-server.sh", "scripts/install-harnesses.mjs", "scripts/configure-opencode.mjs", "scripts/configure-codex.mjs", "scripts/codex-hook.mjs", "scripts/uninstall.sh", "README.md", "INSTALL.md", "UNINSTALL.md", "LICENSE"];
